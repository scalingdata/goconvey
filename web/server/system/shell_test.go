...
func TestShellCommandComposition(t *testing.T) {
	var (
		...
		goConvey         = Command{Output: "[fmt github.com/scalingdata/goconvey/convey net/http net/http/httptest path runtime strconv strings testing time]"}
