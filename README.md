...
[![GoDoc](https://godoc.org/github.com/scalingdata/goconvey?status.svg)](http://godoc.org/github.com/scalingdata/goconvey)
...
------------
	...
	$ go get github.com/scalingdata/goconvey

[Quick start](https://github.com/scalingdata/goconvey/wiki#get-going-in-25-seconds)
-----------
...
import (
    "testing"
    . "github.com/scalingdata/goconvey/convey"
)
...
#### [In the browser](https://github.com/scalingdata/goconvey/wiki/Web-UI)
...
The [web UI](https://github.com/scalingdata/goconvey/wiki/Web-UI) supports traditional Go tests, so use it even if you're not using GoConvey tests.



#### [In the terminal](https://github.com/scalingdata/goconvey/wiki/Execution)
...
[Documentation](https://github.com/scalingdata/goconvey/wiki)
-----------

Check out the

- [GoConvey wiki](https://github.com/scalingdata/goconvey/wiki),
- [![GoDoc](https://godoc.org/github.com/scalingdata/goconvey?status.png)](http://godoc.org/github.com/scalingdata/goconvey)
...
GoConvey is brought to you by [SmartyStreets](https://github.com/smartystreets) and [several contributors](https://github.com/scalingdata/goconvey/graphs/contributors) (Thanks!).
